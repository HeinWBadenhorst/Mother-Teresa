 ...
 *                 Sections and properties now retail their order (HashMap)
 ...
 * @since 1.0
 */
public final class INIFileClass
{
     ...
     */
    public INIFileClass(String pstrPathAndName)
    {
 ...
 *----------------------------------------------------------------------------*/
    ...
    {
        INIFileClass objINI = null;
        String  strFile = null;

        //if (pstrArgs.length == 0) return;

        strFile = InfoManager.TARGET_VOLUME + "\\testini.ini";//pstrArgs[0];
        // Following call will load the strFile if one exists.
        objINI = new INIFileClass(strFile);
...
//        
		...
		//objINI.addSection("Folders", "Folder Directory");
        ...
        String propMap = objINI.getStringProperty("Folders", "folder2");
